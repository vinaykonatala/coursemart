...
import { FieldTimeOutlined, CalendarOutlined, SafetyCertificateOutlined, LaptopOutlined} from '@ant-design/icons';
  ...
  return (
    <div className={`${styles.course} ${type === 'single' ? 'flex' : ''} `}>
        ...
        <div className={styles.content}>
              <Button type="link" className={styles.linkBtn}>Naresh IT Solutions</Button>
            ...
            <Row gutter={20} className={styles.pointsBlock}>
              <Col span={`${type === 'single' ? '6' : '12' }`} className={`${styles.coursePoints} gutter-row`}>
                  <FieldTimeOutlined />
                  14 Weeks
             </Col>
            ...
            {type === 'single' ? <Button type="link" className={styles.linkBtn}>View Course Details</Button> : <Button type="primary" size="large" ghost block>
                View Course Details
            </Button>}
        </div>
    </div>
